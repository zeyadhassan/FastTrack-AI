...
export class AIFilesViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'fasttrack-ai-files';
  ...
  private _getHtmlForWebview() {
    const files = this._getFilesWithAICode();
    ...
    return `
      ...
      <body>
        <h2>Files with AI-Generated Code</h2>
        <div>
          ${files.map(file => `
            <div>
